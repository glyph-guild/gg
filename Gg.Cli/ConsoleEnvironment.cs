...
public static class ConsoleEnvironment
{
    ...
    /// disagree.
    /// </param>
    public static IReadOnlyList<EnvironmentSetting> Read(Configuration? file = null) =>
    [
        Of("EDITOR", file,
        ...
        Of(VcsConfiguration.HostsVariable, file,
        ...
        Of(DestinationConfiguration.ApisVariable, file,
        ...
        Of(ExecutorConfiguration.BinaryVariable, file,
        ...
        Of(StunConfiguration.Variable, file,
    ...
    private static EnvironmentSetting Of(string name, Configuration? file, string why)
    {
        var resolved = Settings.Resolve(name, file);
