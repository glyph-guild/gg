...
public class ApplyCanDeclareTheNamesItNeedsTests
{
    ...
    /// <remarks>
    /// <b>The document is shared and whole.</b> Two earlier drafts of it were
    /// trimmed and did not parse, so the apply refused them as unreadable
    /// files before reaching the topology at all.
    /// </remarks>
